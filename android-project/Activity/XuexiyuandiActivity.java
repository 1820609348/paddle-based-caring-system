...
public class XuexiyuandiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xuexiyuandi);
        ...
        listView = findViewById(R.id.listview_xuexiyuandi);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                intent_x.setClass(XuexiyuandiActivity.this,ShebaokaBanli.class);
