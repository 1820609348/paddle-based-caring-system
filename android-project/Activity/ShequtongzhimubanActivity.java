...
public class ShequtongzhimubanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shequtongzhimuban);
    ...
    private void initView() {
        etText = findViewById(R.id.tv44);

        btnPlay = findViewById(R.id.bofang);
        ...
        rxPermissions.request(Manifest.permission.WRITE_EXTERNAL_STORAGE,
                ...
                .subscribe(grant -> {
                    if (grant) {
                        ...
                        Toast.makeText(ShequtongzhimubanActivity.this,"未获取到权限",Toast.LENGTH_SHORT).show();
                    }
                });
    }
