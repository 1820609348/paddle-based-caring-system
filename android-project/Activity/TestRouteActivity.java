...
import static com.example.myapp.utils.MapUtil.convertToLatLng;
import static com.example.myapp.utils.MapUtil.convertToLatLonPoint;
...
import com.example.myapp.overlay.BusRouteOverlay;
import com.example.myapp.overlay.DrivingRouteOverlay;
import com.example.myapp.overlay.RideRouteOverlay;
import com.example.myapp.overlay.WalkRouteOverlay;
import com.example.myapp.utils.MapUtil;

import java.util.List;

public class TestRouteActivity extends AppCompatActivity implements
    ...
    private static final String TAG = "TestRouteActivity";
    //地图
    ...
    public static boolean jundge = false;
    public static String yuyingendAddress = null;
    private View TestRouteActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent0.getStringExtra("jundge").equals("语音")){
            jundge = true;
            yuyingendAddress = intent0.getStringExtra("voiceEndAddress");
        }
    ...
    public void onLocationChanged(com.amap.api.location.AMapLocation aMapLocation) {
        if (aMapLocation != null) {
            if (aMapLocation.getErrorCode() == 0) {
                ...
                etEndAddress.setText(yuyingendAddress);
                ...
                if (busRouteResult.getPaths().size() > 0) {
                    ...
                    bottomLayout.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Intent intent = new Intent(TestRouteActivity.this,
